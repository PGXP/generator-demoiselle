...
app.factory('ConstanteService', ['$http', function ($http) {
        ...
        service.tipopagamentos = function () {
            return $http.get('api/constantes/tipopagamento').then(function (res) {
                return res;
            });
        };

        service.tiposituacaos = function () {
            return $http.get('api/constantes/tiposituacao').then(function (res) {
                return res;
            });
        };
